...
public class SubtaskAssignee extends TableImpl<SubtaskAssigneeRecord> {
    ...
    public List<Index> getIndexes() {
        return Arrays.asList(Indexes.SUBTASK_ASSIGNEE_PROJECT_ID, Indexes.SUBTASK_ASSIGNEE_SUBTASK_ID);
    }
    ...
    public List<ForeignKey<SubtaskAssigneeRecord, ?>> getReferences() {
        return Arrays.asList(Keys.SUBTASK_ASSIGNEE_IBFK_1, Keys.SUBTASK_ASSIGNEE_IBFK_2, Keys.SUBTASK_ASSIGNEE_IBFK_3);
    }
    ...
    public UserPath user() {
        if (_user == null)
            _user = new UserPath(this, Keys.SUBTASK_ASSIGNEE_IBFK_1, null);
    ...
    public ProjectPath project() {
        if (_project == null)
            _project = new ProjectPath(this, Keys.SUBTASK_ASSIGNEE_IBFK_2, null);
    ...
    public SubtaskPath subtask() {
        if (_subtask == null)
            _subtask = new SubtaskPath(this, Keys.SUBTASK_ASSIGNEE_IBFK_3, null);
